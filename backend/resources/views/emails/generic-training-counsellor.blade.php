                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 24px 0; color: #1f2937; font-size: 16px; font-weight: 500;">Dear {{ $tcName }},</p>

                            <div style="background-color: #f9fafb; border-radius: 12px; padding: 24px; border: 1px solid #e5e7eb; color: #4b5563; font-size: 16px; line-height: 1.7; white-space: pre-wrap;">{{ $emailBody }}</div>
