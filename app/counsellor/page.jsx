  ...
  const validateStep = (step) => {
    ...
    switch (step) {
      ...
      case 2: // Professional Status
        ...
        if (
          formData.faceToFaceBeforeOnline === "Yes" &&
          (!formData.faceToFaceHours || !formData.faceToFaceHours.trim())
        )
          stepErrors.faceToFaceHours = "Please specify required hours";
        break;
      ...
      case 3: // Course Information
        ...
        if (
          formData.faceToFaceRequired === "Yes" &&
          (!formData.faceToFaceHours || !formData.faceToFaceHours.trim())
        )
          stepErrors.faceToFaceHours = "Please specify required hours";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const combinedOtherBeliefs = [
        formData.otherBeliefsSpecify
          ? `Other: ${formData.otherBeliefsSpecify}`
          : "",
      ...
      formDataToSubmit.append(
        "has_insurance",
        formData.hasIndemnityInsurance || "",
      );
      formDataToSubmit.append(
        "professional_body_member",
        formData.professionalBodyMember || "",
      );
      formDataToSubmit.append(
        "professional_body_details",
        formData.professionalBodyDetails || "",
      );
      formDataToSubmit.append(
        "dbs_update_service",
        formData.dbsRegistered || "",
      );
      formDataToSubmit.append(
        "in_personal_therapy",
        formData.inPersonalTherapy || "",
      );
      formDataToSubmit.append(
        "personal_therapy_reason",
        formData.personalTherapyReason || "",
      );
      formDataToSubmit.append(
        "has_clinical_supervisor",
        formData.hasClinicalSupervisor || "",
      );
      formDataToSubmit.append(
        "supervisor_reason",
        formData.supervisorReason || "",
      );
      formDataToSubmit.append(
        "previous_online_counselling",
        formData.previousOnlineCounselling || "",
      );
      formDataToSubmit.append(
      ...
      formDataToSubmit.append(
        "training_org_name",
        formData.trainingOrgName || "",
      );
      formDataToSubmit.append(
        "training_org_address",
        formData.trainingOrgAddress || "",
      );
      formDataToSubmit.append(
        "college_address",
        formData.trainingOrgAddress || "",
      ...
      formDataToSubmit.append(
        ...
        formData.expectedQualification || "",
      );
      formDataToSubmit.append("counselling_type", formData.courseFocus || "");
      formDataToSubmit.append(
        "face_to_face_requirement",
        formData.faceToFaceRequired || "",
      );
      formDataToSubmit.append(
        "face_to_face_hours",
        formData.faceToFaceHours || "",
      );
      formDataToSubmit.append(
        "face_to_face_before_online",
        formData.faceToFaceBeforeOnline || "",
      );
      formDataToSubmit.append(
      ...
      formDataToSubmit.append(
        "placement_lead_name",
        formData.placementLeadName || "",
      );
      formDataToSubmit.append(
        "placement_lead_email",
        formData.placementLeadEmail || "",
      );
      formDataToSubmit.append(
        "placement_lead_phone",
        formData.placementLeadPhone || "",
      );

      // ── Experience & Journey ────────────────────────────────────────
      formDataToSubmit.append(
        "family_impact",
        formData.familyDifficulties || "",
      );
      formDataToSubmit.append(
        "personal_journey",
        formData.personalJourney || "",
      );
      formDataToSubmit.append("self_awareness", formData.selfAwareness || "");
      formDataToSubmit.append(
        "training_history",
        formData.counsellorTraining || "",
      );
      formDataToSubmit.append(
        "areas_of_experience",
        formData.experienceAreas || "",
      );
      formDataToSubmit.append(
      ...
      if (
        formData.theoreticalApproach &&
        formData.theoreticalApproach.length > 0
      ) {
        const approachStr =
          formData.theoreticalApproach.join(", ") +
          (formData.theoreticalApproachOther
            ? ` (${formData.theoreticalApproachOther})`
            : "");
      ...
      // ── Array / JSON fields ─────────────────────────────────────────
      if (
        formData.topicsExperienceWith &&
        formData.topicsExperienceWith.length > 0
      ) {
        formDataToSubmit.append(
          "topics_with_experience",
          JSON.stringify(formData.topicsExperienceWith),
        );
      }
      formDataToSubmit.append(
        "topics_experience_other",
        formData.topicsExperienceOther || "",
      );

      if (formData.topicsNotReady && formData.topicsNotReady.length > 0) {
        formDataToSubmit.append(
          "topics_not_ready_for",
          JSON.stringify(formData.topicsNotReady),
        );
      }
      formDataToSubmit.append(
        "topics_not_ready_other",
        formData.topicsNotReadyOther || "",
      );
        ...
        >
          <div className="flex items-center justify-center p-4 min-h-screen">
            <div className="card rounded-2xl shadow-xl p-8 max-w-md w-full text-center border">
              ...
              <div
                className="rounded-lg p-4 mb-6 border text-center"
                style={{
          ...
          <div className="card rounded-2xl shadow-sm p-4 md:p-8 mb-4 md:mb-6 border">
            <div className="flex flex-col items-center justify-center mb-4 md:mb-6 text-center">
              ...
              <div>
                ...
                <p
                  className="text-sm md:text-base mt-0.5 md:mt-1 font-bold"
                  style={{ color: "var(--text-secondary)" }}
                >
                  Trainee Counsellor Placement Application Form (STAGE 1)
                </p>
                <p
            ...
            <div className="bg-red-50 border-2 border-red-300 rounded-lg p-4 mb-4">
              <ul className="text-sm md:text-base text-red-900 space-y-3 list-disc list-outside ml-5">
                <li className="font-bold">
                  Before proceeding with the application, kindly note the
                  following: You may only submit your placement application once
                  you have started your course, successfully completed your
                  fitness-to-practise assessment, and received your official
                  Fitness to Practise document. Applications with pending
                  fitness to practise will not be processed.
                </li>
                <li className="font-bold">
                  This is the 1st stage of our process. If your placement
                  application is successful, you will be invited to the 2nd
                  stage, which is a short virtual video interview - answering a
                  few questions. If successful in stage 2, you will proceed to
                  the final stage - a face to face virtual interview.
                </li>
                <li className="font-bold">
                  Please be advised: All required fields on the form must be
                  completed. Failure to do so will result in an 'error' message.
          ...
          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  ...
                  <div>
                    ...
                    <SearchableSelect
                      ...
                      options={[
                        ...
                        {
                          value: "African/Caribbean/Black",
                          label: "African/Caribbean/Black",
                        },
                        ...
                        {
                          value: "West Asian (Middle Eastern)",
                          label: "West Asian (Middle Eastern)",
                        },
                        ...
                        {
                          value: "Other",
                          label: "Other (Please use the box below to specify)",
                        },
                      ]}
                      placeholder="Please select"
                    />
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1 font-bold">
                      ...
                      more comfortable with certain perspectives, expertise, or
                      understanding)
                    </p>
                  </div>
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Current Registered Address You Reside At:{" "}
                      <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="md:col-span-2">
                    <label className="block text-sm font-medium text-gray-700 mb-3">
                      Please select your beliefs (If your religion is not
                      listed, select 'Other' and specify below. If your religion
                      is listed but you have specific beliefs, please list them
                      in the 'list if not mentioned' box below){" "}
                      <span className="text-red-500">*</span>
                    </label>
                    <div
                      data-field="beliefs"
                  ...
                  <div className="md:col-span-2 mt-4">
                    {!(
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          handleInputChange("showSpecificBeliefs", true)
                        }
            ...
            {currentStep === 2 && (
              <div className="space-y-4 md:space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-sm md:text-base text-gray-600">
                    Please provide your professional credentials and
                    requirements.
                  </p>
                </div>
                ...
                <div className="space-y-4 md:space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      ...
                      body? (e.g NCPS/BACP/Other) If yes, please provide
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Have you previously attended or are you currently
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      ...
                      If yes, how many face to face hours are required?{" "}
                      <span className="text-red-500">*</span>
                    </label>
                    <select
                  ...
                  {formData.faceToFaceBeforeOnline === "Yes" && (
                    <div className="animate-in fade-in slide-in-from-top-2">
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        How many face to face hours are required?{" "}
                        <span className="text-red-500">*</span>
                      </label>
                      <input
                        type="number"
                        value={formData.faceToFaceHours}
                        onChange={(e) =>
                          handleInputChange("faceToFaceHours", e.target.value)
                        }
                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:border-transparent ${
                          errors.faceToFaceHours
                            ? "border-red-500"
                            : "border-gray-300"
                        }`}
                        placeholder="e.g. 50"
            ...
            {currentStep === 3 && (
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="space-y-4 md:space-y-6">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Does your course cover skills practice (practical elements
                      of Counselling), If yes, please specify the method and
                      duration of your practice sessions with your peers. For
                      Example: Using the Fishbowl method or taking turns being
                      the Counsellor, Observer, and Client. Alternatively, if
                      your course employs a different method, kindly highlight
                      this and provide the details, techniques, and duration of
                ...
                <div className="space-y-4 md:space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-3 italic">
                      ...
                      elements of our struggles and our growth. What
                      difficulties have you encountered within your Family
                      structure, how has this impacted and influenced your
                      journey?
                    </p>
                    <textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Please tell us a little about the personal journey which
                      led you to pursue a career in counselling:
                      <span className="text-red-500">*</span>
                    </label>
                    <textarea
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      ...
                      intelligence crucial to Counselling. Please use this space
                      to give us an example of your own self-awareness and
                    ...
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-700 mb-4">
                          ...
                          experience with, either through training, placement,
                          or practice. This helps us match you with suitable
                          clients.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-700 mb-4">
                          ...
                          ready to handle. This is essential for ethical
                          practice, your wellbeing, and client safety. There is
                          no judgment - it shows good self-awareness.
                        </p>
                      </div>
                    </div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      What areas of personal development do you need to improve
                      on to assist your therapeutic work?{" "}
                      <span className="text-red-500">*</span>
                    </label>
                    <textarea
                  ...
                  <div>
                    ...
                    {formData.theoreticalApproach.includes("Other") && (
                      <div className="mt-4">
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                          Please describe your theoretical approach if not
                          listed above <span className="text-red-500">*</span>
                        </label>
                        <textarea
              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  ...
                  <SearchableSelect
                    ...
                    onChange={(e) =>
                      handleInputChange("psgDay", e.target.value)
                    }
                    options={[
                      {
                        value: "Monday 7pm-8:30pm",
                        label: "Monday 7:00 PM - 8:30 PM",
                      },
                      {
                        value: "Wednesday 7pm-8:30pm",
                        label: "Wednesday 7:00 PM - 8:30 PM",
                      },
                      {
            ...
            {currentStep === 6 && (
              <div className="space-y-4 md:space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-sm md:text-base text-gray-600">
                    Please upload all mandatory documents. Incomplete
                      ...
                      <div className="p-8">
                        <div className="space-y-4 mb-8">
                          <p className="text-gray-700 font-medium">
                            Please review these mandatory requirements before
                            proceeding with your document uploads:
                          </p>
                ...
                <div className="space-y-4 md:space-y-6">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Accepted formats: PDF, Word (.doc, .docx). ONLY APPLY IF
                  ...
                  <div>
                    ...
                    <p className="text-xs text-black mt-1 font-bold">
                      Accepted formats: PDF, Image (JPG, PNG), Word (.doc,
                      .docx)
                    </p>
            ...
            {currentStep === 7 && (
              <div className="space-y-4 md:space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Have you been convicted of a criminal offence within the
                    last 6 months? <span className="text-red-500">*</span>
                  </label>
                  <SearchableSelect
                ...
                <div className="space-y-4 pt-4 border-t border-gray-200">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-700">
                      ...
                      of accurate record. I understand that providing false
                      information may result in the termination of my
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <p className="text-sm text-gray-700">
                      ...
                      touch soon. Please note: a copy of this application will
                      not be provided. Once accepted on placement, we may
                      collect anonymised information for educational and
                      training purposes.
                    </p>
                  </div>
                </div>
